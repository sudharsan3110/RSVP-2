...
export const disposableEmailValidator = z.string().min(1, { message: 'email is required' }).email().refine((email) => {
  const domain = email.split('@')[1];
  return !disposableEmailBlocklist.includes(domain ?? '');
}, {
  message: "Disposable email addresses are not allowed"
})

export const disposableEmailBlocklist = [
  "0-mail.com",
  "027168.com",
  "062e.com",
  "decodewp.com",
...
export const disposableEmailValidator = z
  .string()
